...
public class RedisLookupTableSource implements
    ...
    private RedisLookupTableSource(String[] fieldNames, TypeInformation[] fieldTypes, String ip, int port, long cacheMaxSize, long cacheExpireMs, String password) {
    ...
    public AsyncTableFunction getAsyncLookupFunction(String[] lookupKeys) {
        return RedisLookupFunction.builder()
                ...
                .setCacheExpireMs(cacheExpireMs).setPassword(password)
                .build();
    }
    ...
    public static class Builder {
        ...
        public RedisLookupTableSource build() {
            return new RedisLookupTableSource(fieldNames, fieldTypes, ip, port, cacheMaxSize, cacheExpireMs,password);
        }
    }
}
